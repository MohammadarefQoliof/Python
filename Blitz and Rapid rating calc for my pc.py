    ...
    if str(password) == myPassword:
        ...
        if num > 7:
            ...
            with open(myRatingList, "w") as ratingList:
                ...
                currentRatingFile.write(f"Previous Rating: {myCurrentRating}\n\n")
...
def Rapid():
    location = "C:/Users/HOME/OneDrive/Desktop/Chess.com Ratings with py"
    localStorage = "C:/Users/HOME/OneDrive/Desktop/Məhəmmədarif/Python LocalSotrage/Rapid Rating"
    ...
    everyWeekRatingLocation = location + "/Weekly rating/Rapid Weekly Rating.txt"
